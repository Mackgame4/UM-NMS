...
#let cover(title: "", authors: (), string_date) = {
                           ...
                           
  {
    ...
    place(bottom + left,dx: 68pt,dy:-40pt, {
      text(weight:"bold", size: 120pt, fill: white, [C])
      text(weight:"bold", size: 120pt, fill: blue, [C])
    })
  
    {
      ...
      place(dy: 300pt, {
        ...
        text(size: 20pt, fill: blue, weight: "bold", [Unidade Curricular de \ Comunicações por Computador\ ])
